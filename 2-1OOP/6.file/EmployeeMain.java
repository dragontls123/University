...
public class EmployeeMain {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Object values to be serialized = " + employee.getName() + ";" + employee.getId() + ";"
					+ employee.getDepartment() + ";" + employee.getExpLevel());
			...
			System.out.println("De serialized object values = " + emp.getName() + ";" + emp.getId() + ";"
					+ emp.getDepartment() + ";" + emp.getExpLevel());
			oStream.close();
			iStream.close();
